...
//2 comment)
var without_white_space = whiteSpace.trim(); // trim() is use to remove whitespace
...
var friendNames = ["Maria", "Arwa", "Sakina", "Zainab"]; //[] is use for array/list
...
var friend_names = ["Maria", "Arwa", "Sakina", "Zainab"];
var message = "You’re excelling in your coding classes—keep up the great work!";
